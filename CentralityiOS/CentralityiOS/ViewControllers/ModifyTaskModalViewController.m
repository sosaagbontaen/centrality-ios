...
- (NSString*)updateShareDisplayMessage{
    NSString *shareDisplayMessage = self.taskSharedOwners.count == 1 ? @"Sharing w/ 1 user" : [NSString stringWithFormat:@"Sharing w/ %lu users", (unsigned long)self.taskSharedOwners.count];
